...
const involvedInTheСssQuickDraw2018Q1 = []
arrClone.forEach(elem => {
    let obj = {};
    obj[elem[1]] = []
    for(let i = 0; i < 10; i++) {
        const s = cssQuickDraw2018Q1[i].solutions[elem[0]];
        if(s) {
            obj[elem[1]].push(+s.time.$numberLong);
        }
        else {
            obj[elem[1]].push(150);
        }
    }
    involvedInTheСssQuickDraw2018Q1.push(_.cloneDeep(obj));
});